// ═══════════════════════════════════════════════════════════════════════════
//  PERMANENT BOOK KNOWLEDGE DATABASE — AQUARIUS COMPLETION + PISCES CHAPTER
//  Source: "The Occult Encyclopedia of Magick Squares" — Nineveh Shadrach
//  PDF File: a0273f3f6_...-610-658.pdf
//  Book Pages: 569–617 (49 pages)
//  Processed: 2026-06-07
//  Covers:
//    AQUARIUS COMPLETION (pp.569–583):
//      - Sign Deli 8×8 Mercury squares (all 4 elements) + hierarchy table p.569
//      - Lord of Triplicity by Day: Athor (676) pp.570–578 — Saturn+Mars+Sun+Venus+Mercury+Moon+Saturn10×10
//      - Lord of Triplicity by Night: Polayan (171) pp.579–582 — Saturn+Jupiter+Mars+Sun
//      - Angel Ruling 11th House: Ansuel (148) p.583 — Hebrew squares only (Numerical See p.353)
//      - Angel of First Decanate: Saspam (240) pp.583–587 — Saturn+Jupiter+Mars+Sun+Venus
//    AQUARIUS QUINANCES + DECANATES (pp.588–600):
//      - Angel of First Quinance: Aniel (92) pp.588–589 — Jupiter+Mars
//      - Angel of Second Quinance: Chamiah (133) pp.590–591 — Jupiter+Mars+Sun
//      - Angel of Second Decanate: Abdaron (263) p.593 — Hebrew squares; Numerical See p.411
//      - Angel of Third Quinance: Rehael (306) pp.593–595 — Saturn+Jupiter+Mars+Sun
//      - Angel of Fourth Quinance: Yeyazel (58) p.599 — Hebrew squares; Numerical See p.549
//      - Angel of Third Decanate: Gerodiel (254) p.600 — Hebrew squares; Numerical See p.355
//      - Angel of Fifth Quinance: Hahahel (46) p.600 — Hebrew squares; Numerical See p.90
//      - Angel of Sixth Quinance: Michael (101) p.600 — Hebrew squares; Numerical See p.247
//    PISCES CHAPTER (pp.601–617):
//      - Sign Pisces: Dagim (57) p.601 — Hebrew squares; Numerical See p.436
//      - Archangel of Pisces: Amnitziel (232) p.601 — Jupiter+Mars+Sun+Venus
//      - Angel of Pisces: Vakabiel (69) pp.605–606 — Saturn+Jupiter+Mars
//      - Lord of Triplicity by Day: Ramara (441) pp.607–611 — Saturn+Jupiter+Mars+Sun+Venus+Mercury+Moon
//      - Lord of Triplicity by Night: Nathdorinel (751) pp.615–617 — Jupiter+Mars+Sun+Venus(partial)
// ═══════════════════════════════════════════════════════════════════════════

// ─────────────────────────────────────────────────────────────────────────────
//  SECTION A — AQUARIUS: SIGN DELI — 8×8 MERCURY SQUARES (p.569)
//  These complete the Deli(44) entity's Mercury 8×8 squares
//  (The Aquarius sign Deli=44 uses See Page:1 for Aries, but has its own Mercury grids)
// ─────────────────────────────────────────────────────────────────────────────
export const AQUARIUS_DELI_MERCURY_SQUARES = {
  entity: "Sign Aquarius: Deli", hebrewValue: 44,
  note: "No Hebrew Squares Available — See Page 1 for numerical (same as Aries)",
  page: "569",
  mercurySquare: {
...
// ─────────────────────────────────────────────────────────────────────────────
//  SECTION B — AQUARIUS: LORD OF TRIPLICITY BY DAY: ATHOR (676) (pp.570–578)
// ─────────────────────────────────────────────────────────────────────────────
export const AQUARIUS_ATHOR = {
  name: "Lord of Triplicity by Day: Athor", hebrewValue: 676,
  sign: "Aquarius", page: "570",
...
// ─────────────────────────────────────────────────────────────────────────────
//  SECTION C — AQUARIUS: LORD OF TRIPLICITY BY NIGHT: POLAYAN (171) (pp.579–582)
// ─────────────────────────────────────────────────────────────────────────────
export const AQUARIUS_POLAYAN = {
  name: "Lord of Triplicity by Night: Polayan", hebrewValue: 171,
  sign: "Aquarius", page: "579",
...
// ─────────────────────────────────────────────────────────────────────────────
//  SECTION D — AQUARIUS: ANGEL RULING 11TH HOUSE: ANSUEL (148) (p.583)
// ─────────────────────────────────────────────────────────────────────────────
export const AQUARIUS_ANSUEL = {
  name: "Angel Ruling 11th House: Ansuel", hebrewValue: 148,
  house: 11, sign: "Aquarius", page: "583",
  note: "Numerical Squares See Page: 353",
  hebrewSquare: { numerical: [[50,61,9,28],[8,29,49,62],[59,52,30,7]] },
};

// ─────────────────────────────────────────────────────────────────────────────
//  SECTION E — AQUARIUS: ANGEL OF FIRST DECANATE: SASPAM (240) (pp.583–587)
// ─────────────────────────────────────────────────────────────────────────────
export const AQUARIUS_SASPAM = {
  name: "Angel of First Decanate: Saspam", hebrewValue: 240,
  sign: "Aquarius", page: "584",
  ...
  sunSquare: {
    fire:  [[22,33,56,39,43,47],[28,38,49,55,26,44],[34,59,42,32,48,25],[45,24,35,50,29,57],[51,40,31,23,58,37],[60,46,27,41,36,30]],
    earth: [[60,51,45,34,28,22],[46,40,24,59,38,33],[27,31,35,42,49,56],[41,23,50,32,55,39],[36,58,29,48,26,43],[30,37,57,25,44,47]],
    air:   [[30,36,41,27,46,60],[37,58,23,31,40,51],[57,29,50,35,24,45],[25,48,32,42,59,34],[44,26,55,49,38,28],[47,43,39,56,33,22]],
    water: [[47,44,25,57,37,30],[43,26,48,29,58,36],[39,55,32,50,23,41],[56,49,42,35,31,27],[33,38,59,24,40,46],[22,28,34,45,51,60]],
...
// ─────────────────────────────────────────────────────────────────────────────
//  SECTION F — AQUARIUS QUINANCES & REMAINING DECANATES (pp.588–600)
// ─────────────────────────────────────────────────────────────────────────────
export const AQUARIUS_QUINANCES_DECANATES = {

  aniel: {
    name: "Angel of First Quinance: Aniel", hebrewValue: 92,
    sign: "Aquarius", page: "588",
  ...
  chamiah: {
    ...
    sunSquare_fire: [[4,15,39,21,25,29],[10,20,31,38,8,26],[16,42,24,14,30,7],[27,6,17,32,11,40],[33,22,13,5,41,19],[43,28,9,23,18,12]],
    sunSquare_air:  [[12,18,23,9,28,43],[19,41,5,13,22,33],[40,11,32,17,6,27],[7,30,14,24,42,16],[26,8,38,31,20,10],[29,25,21,39,15,4]],
    sunSquare_earth:[[43,33,27,16,10,4],[28,22,6,42,20,15],[9,13,17,24,31,39],[23,5,32,14,38,21],[18,41,11,30,8,25],[12,19,40,7,26,29]],
    sunSquare_water:[[29,26,7,40,19,12],[25,8,30,11,41,18],[21,38,14,32,5,23],[39,31,24,17,13,9],[15,20,42,6,22,28],[4,10,16,27,33,43]],
    sunHierarchy: { usurper:4, guide:43, mystery:47, adjuster:133, leader:399, regulator:532, genGov:1064, highOverseer:45752 },
    sunAngelArabic: { usurper:323, guide:2, mystery:6, adjuster:92, leader:358, regulator:491, genGov:1023, highOverseer:45711 },
    sunAngelHebrew: { usurper:333, guide:12, mystery:16, adjuster:102, leader:368, regulator:501, genGov:1033, highOverseer:45721 },
    sunJinnArabic:  { usurper:45, guide:84, mystery:88, adjuster:174, leader:80, regulator:213, genGov:745, highOverseer:45433 },
    sunJinnHebrew:  { usurper:35, guide:74, mystery:78, adjuster:164, leader:70, regulator:203, genGov:735, highOverseer:45423 },
  },

  abdaron: {
    name: "Angel of Second Decanate: Abdaron", hebrewValue: 263,
    sign: "Aquarius", page: "593",
  ...
  michael_aquarius: {
    name: "Angel of Sixth Quinance: Michael", hebrewValue: 101,
    sign: "Aquarius", page: "600",
...
// ─────────────────────────────────────────────────────────────────────────────
//  SECTION G — PISCES CHAPTER (pp.601–617)
// ─────────────────────────────────────────────────────────────────────────────

// SIGN PISCES: DAGIM (57)
export const PISCES_DAGIM = {
  name: "Sign Pisces: Dagim", hebrewValue: 57,
  rulingPlanet: "Jupiter", chapterStart: 601,
  note: "Numerical Squares See Page: 436",
  hebrewSquare: { numerical: [[3,4,13,37],[12,38,2,5],[2,5,39,11]] },
};

// ARCHANGEL OF PISCES: AMNITZIEL (232)
...
export const PISCES_RAMARA = {
  ...
  sunSquare: {
    fire:  [[56,67,87,73,77,81],[62,72,83,86,60,78],[68,90,76,66,82,59],[79,58,69,84,63,88],[85,74,65,57,89,71],[91,80,61,75,70,64]],
    air:   [[64,70,75,61,80,91],[71,89,57,65,74,85],[88,63,84,69,58,79],[59,82,66,76,90,68],[78,60,86,83,72,62],[81,77,73,87,67,56]],
    earth: [[91,85,79,68,62,56],[80,74,58,90,72,67],[61,65,69,76,83,87],[75,57,84,66,86,73],[70,89,63,82,60,77],[64,71,88,59,78,81]],
    water: [[81,78,59,88,71,64],[77,60,82,63,89,70],[73,86,66,84,57,75],[87,83,76,69,65,61],[67,72,90,58,74,80],[56,62,68,79,85,91]],
    hierarchy: { usurper:56, guide:91, mystery:147, adjuster:441, leader:1323, regulator:1764, genGov:3528, highOverseer:321048 },
    angelArabic: { usurper:15, guide:50, mystery:106, adjuster:400, leader:1282, regulator:1723, genGov:3487, highOverseer:321007 },
    angelHebrew: { usurper:25, guide:60, mystery:116, adjuster:410, leader:1292, regulator:1733, genGov:3497, highOverseer:321017 },
    jinnArabic:  { usurper:97, guide:132, mystery:188, adjuster:122, leader:1004, regulator:1445, genGov:3209, highOverseer:320729 },
    jinnHebrew:  { usurper:87, guide:122, mystery:178, adjuster:112, leader:994, regulator:1435, genGov:3199, highOverseer:320719 },
  },

  venusSquare: {
    fire:  [[39,80,65,50,70,83,54],[84,55,40,74,66,51,71],[52,72,85,56,41,75,60],[76,61,46,73,86,57,42],[58,43,77,62,47,67,87],[68,81,59,44,78,63,48],[64,49,69,82,53,45,79]],
    air:   [[79,45,53,82,69,49,64],[48,63,78,44,59,81,68],[87,67,47,62,77,43,58],[42,57,86,73,46,61,76],[60,75,41,56,85,72,52],[71,51,66,74,40,55,84],[54,83,70,50,65,80,39]],
    earth: [[64,68,58,76,52,84,39],[49,81,43,61,72,55,80],[69,59,77,46,85,40,65],[82,44,62,73,56,74,50],[53,78,47,86,41,66,70],[45,63,67,57,75,51,83],[79,48,87,42,60,71,54]],
    water: [[54,71,60,42,87,48,79],[83,51,75,57,67,63,45],[70,66,41,86,47,78,53],[50,74,56,73,62,44,82],[65,40,85,46,77,59,69],[80,55,72,61,43,81,49],[39,84,52,76,58,68,64]],
    hierarchy: { usurper:39, guide:87, mystery:126, adjuster:441, leader:1323, regulator:1764, genGov:3528, highOverseer:306936 },
    angelArabic: { usurper:358, guide:46, mystery:85, adjuster:400, leader:1282, regulator:1723, genGov:3487, highOverseer:306895 },
    angelHebrew: { usurper:8, guide:56, mystery:95, adjuster:410, leader:1292, regulator:1733, genGov:3497, highOverseer:306905 },
    jinnArabic:  { usurper:80, guide:128, mystery:167, adjuster:122, leader:1004, regulator:1445, genGov:3209, highOverseer:306617 },
    jinnHebrew:  { usurper:70, guide:118, mystery:157, adjuster:112, leader:994, regulator:1435, genGov:3199, highOverseer:306607 },
  },

  mercurySquare: {
    fire:  [[23,39,89,68,57,73,54,38],[31,47,76,60,65,86,46,30],[74,58,37,53,40,24,67,88],[87,66,29,45,48,32,59,75],[52,36,55,71,91,70,25,41],[44,28,63,84,78,62,33,49],[69,90,42,26,35,51,72,56],[61,77,50,34,27,43,85,64]],
    earth: [[61,69,44,52,87,74,31,23],[77,90,28,36,66,58,47,39],[50,42,63,55,29,37,76,89],[34,26,84,71,45,53,60,68],[27,35,78,91,48,40,65,57],[43,51,62,70,32,24,86,73],[85,72,33,25,59,67,46,54],[64,56,49,41,75,88,30,38]],
    air:   [[64,85,43,27,34,50,77,61],[56,72,51,35,26,42,90,69],[49,33,62,78,84,63,28,44],[41,25,70,91,71,55,36,52],[75,59,32,48,45,29,66,87],[88,67,24,40,53,37,58,74],[30,46,86,65,60,76,47,31],[38,54,73,57,68,89,39,23]],
    water: [[38,30,88,75,41,49,56,64],[54,46,67,59,25,33,72,85],[73,86,24,32,70,62,51,43],[57,65,40,48,91,78,35,27],[68,60,53,45,71,84,26,34],[89,76,37,29,55,63,42,50],[39,47,58,66,36,28,90,77],[23,31,74,87,52,44,69,61]],
    hierarchy: { usurper:23, guide:91, mystery:114, adjuster:441, leader:1323, regulator:1764, genGov:3528, highOverseer:321048 },
    angelArabic: { usurper:342, guide:50, mystery:73, adjuster:400, leader:1282, regulator:1723, genGov:3487, highOverseer:321007 },
    angelHebrew: { usurper:352, guide:60, mystery:83, adjuster:410, leader:1292, regulator:1733, genGov:3497, highOverseer:321017 },
    jinnArabic:  { usurper:64, guide:132, mystery:155, adjuster:122, leader:1004, regulator:1445, genGov:3209, highOverseer:320729 },
    jinnHebrew:  { usurper:54, guide:122, mystery:145, adjuster:112, leader:994, regulator:1435, genGov:3199, highOverseer:320719 },
  },

  moonSquare: {
    fire:  [[53,66,28,37,89,21,57,73,17],[13,56,78,33,49,65,20,42,85],[81,25,41,77,9,61,70,32,45],[80,12,55,64,35,48,84,19,44],[40,83,24,60,76,11,47,69,31],[27,52,68,23,36,88,16,59,72],[26,39,82,10,62,75,30,46,71],[67,29,51,87,22,38,74,15,58],[54,79,14,50,63,34,43,86,18]],
    earth: [[17,85,45,44,31,72,71,58,18],[73,42,32,19,69,59,46,15,86],[57,20,70,84,47,16,30,74,43],[21,65,61,48,11,88,75,38,34],[89,49,9,35,76,36,62,22,63],[37,33,77,64,60,23,10,87,50],[28,78,41,55,24,68,82,51,14],[66,56,25,12,83,52,39,29,79],[53,13,81,80,40,27,26,67,54]],
    air:   [[18,86,43,34,63,50,14,79,54],[58,15,74,38,22,87,51,29,67],[71,46,30,75,62,10,82,39,26],[72,59,16,88,36,23,68,52,27],[31,69,47,11,76,60,24,83,40],[44,19,84,48,35,64,55,12,80],[45,32,70,61,9,77,41,25,81],[85,42,20,65,49,33,78,56,13],[17,73,57,21,89,37,28,66,53]],
    water: [[54,67,26,27,40,80,81,13,53],[79,29,39,52,83,12,25,56,66],[14,51,82,68,24,55,41,78,28],[50,87,10,23,60,64,77,33,37],[63,22,62,36,76,35,9,49,89],[34,38,75,88,11,48,61,65,21],[43,74,30,16,47,84,70,20,57],[86,15,46,59,69,19,32,42,73],[18,58,71,72,31,44,45,85,17]],
    hierarchy: { usurper:9, guide:89, mystery:98, adjuster:441, leader:1323, regulator:1764, genGov:3528, highOverseer:313992 },
    angelArabic: { usurper:328, guide:48, mystery:57, adjuster:400, leader:1282, regulator:1723, genGov:3487, highOverseer:313951 },
    angelHebrew: { usurper:338, guide:58, mystery:67, adjuster:410, leader:1292, regulator:1733, genGov:3497, highOverseer:313961 },
    jinnArabic:  { usurper:50, guide:130, mystery:139, adjuster:122, leader:1004, regulator:1445, genGov:3209, highOverseer:313673 },
    jinnHebrew:  { usurper:40, guide:120, mystery:129, adjuster:112, leader:994, regulator:1435, genGov:3199, highOverseer:313663 },
  },
};

// LORD OF TRIPLICITY BY NIGHT: NATHDORINEL (751)
export const PISCES_NATHDORINEL = {
  name: "Lord of Triplicity by Night: Nathdorinel", hebrewValue: 751,
  page: "615",
  hebrewSquare: { numerical: [[453,207,63,28],[62,29,452,208],[205,455,30,61]] },

  jupiterSquare: {
    fire:  [[180,191,185,195],[194,186,188,183],[190,181,196,184],[187,193,182,189]],
    air:   [[189,182,193,187],[184,196,181,190],[183,188,186,194],[195,185,191,180]],
    earth: [[187,190,194,180],[193,181,186,191],[182,196,188,185],[189,184,183,195]],
    water: [[195,183,184,189],[185,188,196,182],[191,186,181,193],[180,194,190,187]],
    hierarchy: { usurper:180, guide:196, mystery:376, adjuster:6008, leader:18024, regulator:24032, genGov:48064, highOverseer:9420544 },
    angelArabic: { usurper:139, guide:155, mystery:335, adjuster:5967, leader:17983, regulator:23991, genGov:48023, highOverseer:9420503 },
    angelHebrew: { usurper:149, guide:165, mystery:345, adjuster:5977, leader:17993, regulator:24001, genGov:48033, highOverseer:9420513 },
    jinnArabic:  { usurper:221, guide:237, mystery:57, adjuster:5689, leader:17705, regulator:23713, genGov:47745, highOverseer:9420225 },
    jinnHebrew:  { usurper:211, guide:227, mystery:47, adjuster:5679, leader:17695, regulator:23703, genGov:47735, highOverseer:9420215 },
  },

  marsSquare: {
    fire:  [[138,163,156,150,144],[151,145,139,159,157],[160,153,152,146,140],[147,141,161,154,148],[155,149,143,142,162]],
    air:   [[155,147,160,151,138],[149,141,153,145,163],[143,161,152,139,156],[142,154,146,159,150],[162,148,140,157,144]],
    earth: [[162,142,143,149,155],[148,154,161,141,147],[140,146,152,153,160],[157,159,139,145,151],[144,150,156,163,138]],
    water: [[144,157,140,148,162],[150,159,146,154,142],[156,139,152,161,143],[163,145,153,141,149],[138,151,160,147,155]],
    hierarchy: { usurper:138, guide:163, mystery:301, adjuster:751, leader:2253, regulator:3004, genGov:6008, highOverseer:979304 },
    angelArabic: { usurper:97, guide:122, mystery:260, adjuster:710, leader:2212, regulator:2963, genGov:5967, highOverseer:979263 },
    angelHebrew: { usurper:107, guide:132, mystery:270, adjuster:720, leader:2222, regulator:2973, genGov:5977, highOverseer:979273 },
    jinnArabic:  { usurper:179, guide:204, mystery:342, adjuster:432, leader:1934, regulator:2685, genGov:5689, highOverseer:978985 },
    jinnHebrew:  { usurper:169, guide:194, mystery:332, adjuster:422, leader:1924, regulator:2675, genGov:5679, highOverseer:978975 },
  },

  sunSquare: {
    fire:  [[107,118,142,124,128,132],[113,123,134,141,111,129],[119,145,127,117,133,110],[130,109,120,135,114,143],[136,125,116,108,144,122],[146,131,112,126,121,115]],
    air:   [[115,121,126,112,131,146],[122,144,108,116,125,136],[143,114,135,120,109,130],[110,133,117,127,145,119],[129,111,141,134,123,113],[132,128,124,142,118,107]],
    earth: [[146,136,130,119,113,107],[131,125,109,145,123,118],[112,116,120,127,134,142],[126,108,135,117,141,124],[121,144,114,133,111,128],[115,122,143,110,129,132]],
    water: [[132,129,110,143,122,115],[128,111,133,114,144,121],[124,141,117,135,108,126],[142,134,127,120,116,112],[118,123,145,109,125,131],[107,113,119,130,136,146]],
    hierarchy: { usurper:107, guide:146, mystery:253, adjuster:751, leader:2253, regulator:3004, genGov:6008, highOverseer:877168 },
    angelArabic: { usurper:66, guide:105, mystery:212, adjuster:710, leader:2212, regulator:2963, genGov:5967, highOverseer:877127 },
    angelHebrew: { usurper:76, guide:115, mystery:222, adjuster:720, leader:2222, regulator:2973, genGov:5977, highOverseer:877137 },
    jinnArabic:  { usurper:148, guide:187, mystery:294, adjuster:432, leader:1934, regulator:2685, genGov:5689, highOverseer:876849 },
    jinnHebrew:  { usurper:138, guide:177, mystery:284, adjuster:422, leader:1924, regulator:2675, genGov:5679, highOverseer:876839 },
  },

  venusSquare_fire: [[83,124,109,94,114,129,98],[130,99,84,118,110,95,115],[96,116,131,100,85,119,104],[120,105,90,117,132,101,86],[102,87,121,106,91,111,133],[112,127,103,88,122,107,92],[108,93,113,128,97,89,123]],
  note: "Venus and remaining planetary squares for Nathdorinel continue beyond this PDF; fire square p.617 extracted above",
};

// ─────────────────────────────────────────────────────────────────────────────
//  SECTION H — AQUARIUS CHAPTER CATALOG (COMPLETE)
// ─────────────────────────────────────────────────────────────────────────────
export const AQUARIUS_CHAPTER_CATALOG = {
  sign: "Aquarius",
  hebrewName: "Deli", hebrewValue: 44,
  chapterPages: "559–600",
  status: "COMPLETE — all 15 entities stored",
  entities: [
    { order:1,  name:"Sign Deli(44)",           page:"559", note:"No Hebrew; See p.1" },
    { order:2,  name:"Archangel Kambriel(304)",  page:"559", status:"stored in prior batch" },
    { order:3,  name:"Angel of Aquarius",        page:"559", status:"stored in prior batch" },
    { order:4,  name:"Lord of Triplicity Day: Athor(676)", page:"570", status:"COMPLETE" },
    { order:5,  name:"Lord of Triplicity Night: Polayan(171)", page:"579", status:"COMPLETE" },
    { order:6,  name:"Angel 11th House: Ansuel(148)", page:"583", status:"COMPLETE" },
    { order:7,  name:"1st Decanate: Saspam(240)", page:"584", status:"COMPLETE" },
    { order:8,  name:"1st Quinance: Aniel(92)",   page:"588", status:"COMPLETE" },
    { order:9,  name:"2nd Quinance: Chamiah(133)", page:"590", status:"COMPLETE" },
    { order:10, name:"2nd Decanate: Abdaron(263)", page:"593", note:"See p.411" },
    { order:11, name:"3rd Quinance: Rehael(306)", page:"593", status:"COMPLETE" },
    { order:12, name:"4th Quinance: Yeyazel(58)", page:"599", note:"See p.549" },
    { order:13, name:"3rd Decanate: Gerodiel(254)", page:"600", note:"See p.355" },
    { order:14, name:"5th Quinance: Hahahel(46)", page:"600", note:"See p.90" },
    { order:15, name:"6th Quinance: Michael(101)", page:"600", note:"See p.247" },
  ],
};

// ─────────────────────────────────────────────────────────────────────────────
//  SECTION I — PISCES CHAPTER CATALOG (PARTIAL)
// ─────────────────────────────────────────────────────────────────────────────
export const PISCES_CHAPTER_CATALOG = {
  sign: "Pisces",
  hebrewName: "Dagim", hebrewValue: 57,
  rulingPlanet: "Jupiter",
  chapterStart: 601,
  status: "PARTIALLY COMPLETE — Sign + Archangel + Angel + Lord Day + Lord Night (partial) extracted",
  entitiesExtracted: [
    { order:1,  name:"Sign Dagim(57)",              page:601, note:"See p.436", status:"COMPLETE" },
    { order:2,  name:"Archangel Amnitziel(232)",    page:601, status:"COMPLETE" },
    { order:3,  name:"Angel Vakabiel(69)",          page:605, status:"COMPLETE" },
    { order:4,  name:"Lord Day Ramara(441)",        page:607, status:"COMPLETE — all 7 planetary sizes" },
    { order:5,  name:"Lord Night Nathdorinel(751)", page:615, status:"PARTIAL — Jupiter+Mars+Sun+Venus(fire only)" },
    { order:6,  name:"Angel 12th House",           page:"619+", status:"MISSING" },
    { order:7,  name:"1st Decanate",               page:"619+", status:"MISSING" },
    { order:8,  name:"2nd Decanate",               page:"619+", status:"MISSING" },
    { order:9,  name:"3rd Decanate",               page:"619+", status:"MISSING" },
    { order:10, name:"1st Quinance",               page:"619+", status:"MISSING" },
    { order:11, name:"2nd Quinance",               page:"619+", status:"MISSING" },
    { order:12, name:"3rd Quinance",               page:"619+", status:"MISSING" },
    { order:13, name:"4th Quinance",               page:"619+", status:"MISSING" },
    { order:14, name:"5th Quinance",               page:"619+", status:"MISSING" },
    { order:15, name:"6th Quinance",               page:"619+", status:"MISSING" },
  ],
};

// ─────────────────────────────────────────────────────────────────────────────
//  SECTION J — HO VERIFICATION FOR THIS PDF BATCH
// ─────────────────────────────────────────────────────────────────────────────
export const AQUARIUS_PISCES_HO_VERIFICATION = {
  rule: "HighOverseer = GenGov × Guide",
  verified: true,
  examples: [
    { entity:"Deli Mercury", genGov:2328, guide:74, result:172272 },
    ...
    { entity:"Athor Saturn 10×10", genGov:5408, guide:118, result:638144 },
    { entity:"Polayan Saturn", genGov:1368, guide:61, result:83448 },
    { entity:"Polayan Jupiter", genGov:10944, guide:51, result:558144 },
    { entity:"Polayan Mars", genGov:1368, guide:47, result:64296 },
    { entity:"Polayan Sun", genGov:1368, guide:46, result:62928 },
    { entity:"Saspam Saturn", genGov:1920, guide:84, result:161280 },
    { entity:"Saspam Jupiter", genGov:15360, guide:69, result:1059840 },
    { entity:"Saspam Mars", genGov:1920, guide:60, result:115200 },
    { entity:"Saspam Sun", genGov:1920, guide:60, result:115200 },
    { entity:"Saspam Venus", genGov:1920, guide:60, result:115200 },
    { entity:"Aniel Jupiter", genGov:5888, guide:32, result:188416 },
    { entity:"Aniel Mars", genGov:736, guide:32, result:23552 },
    { entity:"Chamiah Jupiter", genGov:8512, guide:43, result:366016 },
    { entity:"Chamiah Mars", genGov:1064, guide:41, result:43624 },
    { entity:"Chamiah Sun", genGov:1064, guide:43, result:45752 },
    { entity:"Rehael Saturn", genGov:2448, guide:106, result:259488 },
    { entity:"Rehael Jupiter", genGov:19584, guide:84, result:1645056 },
    { entity:"Rehael Mars", genGov:2448, guide:74, result:181152 },
    { entity:"Rehael Sun", genGov:2448, guide:71, result:173808 },
    { entity:"Rehael Venus", genGov:2448, guide:72, result:176256 },
    { entity:"Rehael Mercury", genGov:2448, guide:75, result:183600 },
    { entity:"Amnitziel Jupiter", genGov:14848, guide:67, result:994816 },
    { entity:"Amnitziel Mars", genGov:1856, guide:60, result:111360 },
    { entity:"Amnitziel Sun", genGov:1856, guide:57, result:105792 },
    { entity:"Amnitziel Venus", genGov:1856, guide:58, result:107648 },
    { entity:"Vakabiel Saturn", genGov:552, guide:27, result:14904 },
    { entity:"Vakabiel Jupiter", genGov:4416, guide:27, result:119232 },
    { entity:"Vakabiel Mars", genGov:552, guide:29, result:16008 },
    ...
    { entity:"Ramara Sun", genGov:3528, guide:91, result:321048 },
    { entity:"Ramara Venus", genGov:3528, guide:87, result:306936 },
    { entity:"Ramara Mercury", genGov:3528, guide:91, result:321048 },
    { entity:"Ramara Moon", genGov:3528, guide:89, result:313992 },
    { entity:"Nathdorinel Jupiter", genGov:48064, guide:196, result:9420544 },
    { entity:"Nathdorinel Mars", genGov:6008, guide:163, result:979304 },
    { entity:"Nathdorinel Sun", genGov:6008, guide:146, result:877168 },
  ],
};

// ─────────────────────────────────────────────────────────────────────────────
//  SECTION K — PROCESSING LOG
// ─────────────────────────────────────────────────────────────────────────────
export const AQUARIUS_PISCES_PDF_LOG = {
  id: "PDF-AQUARIUS-PISCES-PP569-617",
  date_added: "2026-06-07",
  source: "PDF: a0273f3f6_Occult_Encyclopedia_of_Magic_Squares_Planetary_Angels_and_Spirits-610-658.pdf",
  bookPagesProcessed: "569–617 (49 pages)",
  chaptersProcessed: [
    "Aquarius: Deli(44) Mercury 8×8 elemental squares p.569",
    "Aquarius: Lord Triplicity Day Athor(676) pp.570–578 — Jupiter+Mars+Sun+Venus+Mercury+Moon+Saturn10×10",
    "Aquarius: Lord Triplicity Night Polayan(171) pp.579–582 — Saturn+Jupiter+Mars+Sun",
    "Aquarius: Angel 11th House Ansuel(148) p.583 — Hebrew squares, Numerical See p.353",
    "Aquarius: 1st Decanate Saspam(240) pp.584–587 — Saturn+Jupiter+Mars+Sun+Venus",
    "Aquarius: 1st Quinance Aniel(92) pp.588–589 — Jupiter+Mars",
    "Aquarius: 2nd Quinance Chamiah(133) pp.590–592 — Jupiter+Mars+Sun",
    "Aquarius: 2nd Decanate Abdaron(263) p.593 — Hebrew squares, Numerical See p.411",
    "Aquarius: 3rd Quinance Rehael(306) pp.593–598 — Saturn+Jupiter+Mars+Sun+Venus+Mercury",
    "Aquarius: 4th Quinance Yeyazel(58) p.599 — Hebrew squares, Numerical See p.549",
    "Aquarius: 3rd Decanate Gerodiel(254) p.600 — Hebrew squares, Numerical See p.355",
    "Aquarius: 5th Quinance Hahahel(46) p.600 — Hebrew squares, Numerical See p.90",
    "Aquarius: 6th Quinance Michael(101) p.600 — Hebrew squares, Numerical See p.247",
    "Pisces: Sign Dagim(57) p.601 — Hebrew squares, Numerical See p.436",
    "Pisces: Archangel Amnitziel(232) pp.601–604 — Jupiter+Mars+Sun+Venus",
    "Pisces: Angel Vakabiel(69) pp.605–606 — Saturn+Jupiter+Mars",
    "Pisces: Lord Day Ramara(441) pp.607–614 — Saturn+Jupiter+Mars+Sun+Venus+Mercury+Moon",
    "Pisces: Lord Night Nathdorinel(751) pp.615–617 — Jupiter+Mars+Sun+Venus(fire partial)",
  ],
  newEntitiesAdded: 17,
  newPlanetaryTablesAdded: 98,
  criticalFindings: [
    "AQUARIUS CHAPTER NOW COMPLETE — all 15 entities stored",
    "Aquarius Lord Day = Athor = 676 (confirmed)",
    "Aquarius Lord Night = Polayan = 171 (confirmed)",
    "Aquarius 11th House Angel = Ansuel = 148 (confirmed)",
    "Aquarius 1st Decanate = Saspam = 240 (confirmed)",
    "Aquarius Quinances: Aniel(92), Chamiah(133), Abdaron-See-411, Rehael(306), Yeyazel-See-549",
    "Aquarius 3rd Decanate = Gerodiel = 254, 5th Quinance = Hahahel = 46, 6th Quinance = Michael = 101",
    "PISCES CHAPTER OPENED — Sign Dagim(57), Archangel Amnitziel(232), Angel Vakabiel(69) stored",
    "Pisces Lord Day = Ramara = 441 — ALL 7 planetary sizes COMPLETE",
    "Pisces Lord Night = Nathdorinel = 751 — Jupiter+Mars+Sun extracted; Venus+Mercury+Moon+Saturn still cut off",
    "Nathdorinel(751) has 9×9 Hebrew letter square — confirmed p.615",
    "HighOverseer = GenGov × Guide: confirmed on all 44 entities — zero exceptions",
    "House 11 Angel = Ansuel = 148 — confirms house catalog: House 11 → Aquarius → Ansuel",
  ],
  remainingMissing: "Pisces pp.619–653: Nathdorinel continuation (Venus/Mercury/Moon/Saturn), 12th House Angel, 3 Decanates, 6 Quinances (~11 entities + remaining Nathdorinel planetary tables)",
};

export default {
  AQUARIUS_DELI_MERCURY_SQUARES,
  AQUARIUS_ATHOR, AQUARIUS_POLAYAN, AQUARIUS_ANSUEL, AQUARIUS_SASPAM,
  AQUARIUS_QUINANCES_DECANATES,
  AQUARIUS_CHAPTER_CATALOG,
  PISCES_DAGIM, PISCES_AMNITZIEL, PISCES_VAKABIEL,
  PISCES_RAMARA, PISCES_NATHDORINEL,
  PISCES_CHAPTER_CATALOG,
  AQUARIUS_PISCES_HO_VERIFICATION, AQUARIUS_PISCES_PDF_LOG,
};