...
export { MANSIONS_LAYER1, MANSION_OPERATIONS_TABLE, ZODIAC_MANSION_TABLE, TAHSEEN_LIST, SARF_FORMULAS, SARF_RETURN_FORMULAS, AZIMA_SHAJARA, AZIMA_IDRIS, SARF_AMMAR_INTRO };