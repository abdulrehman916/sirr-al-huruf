...
export const ELEMENTS = {
  fire: {
    ...
    arabicColor: "#ffffff",
    numberColor: "#FFD0B0",
    glow: "rgba(247, 92, 60, 0.16)",
    bg: "linear-gradient(135deg, rgba(247,92,60,0.13), rgba(255,179,71,0.09))",
    dominantBg: "linear-gradient(135deg, #F75C3C 0%, #FF8C42 60%, #FFB347 100%)",
    dominantShadow: "0 10px 25px rgba(255,120,60,0.25), inset 0 1px 2px rgba(255,255,255,0.12)",
    dominantBorder: "1px solid rgba(255,140,66,0.40)",
