...
export const ELEMENTS = {
  fire: {
    ...
    arabicColor: "#ffffff",
    numberColor: "#FFD0B0",
    glow: "rgba(249, 94, 63, 0.18)",
    bg: "linear-gradient(135deg, rgba(249,94,63,0.15), rgba(255,169,77,0.10))",
    dominantBg: "linear-gradient(135deg, #F95E3F 0%, #FF8C42 50%, #FFA94D 100%)",
    dominantShadow: "0 8px 20px rgba(255,107,74,0.25), inset 0 1px 2px rgba(255,255,255,0.10)",
    dominantBorder: "1px solid rgba(255,140,66,0.50)",
    border: "rgba(255, 140, 66, 0.50)",
    icon: "🔥",
  },
  air: {
    name: "Air",
