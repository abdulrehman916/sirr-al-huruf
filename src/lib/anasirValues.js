...
export const ELEMENTS = {
  fire: {
    ...
    arabicColor: "#ffffff",
    numberColor: "#FFD0B0",
    glow: "rgba(200, 80, 50, 0.15)",
    bg: "linear-gradient(135deg, rgba(200,80,50,0.16), rgba(220,140,60,0.10))",
    dominantBg: "linear-gradient(135deg, #C85230 0%, #D97230 55%, #E89A3A 100%)",
    dominantShadow: "0 10px 28px rgba(180,70,40,0.30), 0 2px 8px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.10)",
    border: "rgba(200, 90, 55, 0.40)",
    icon: "🔥",
  },
  air: {
    name: "Air",
