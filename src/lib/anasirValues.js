...
export const ELEMENTS = {
  fire: {
    ...
    arabicColor: "#ffffff",
    numberColor: "#FFD0B0",
    glow: "rgba(220, 80, 45, 0.14)",
    bg: "linear-gradient(135deg, rgba(220,80,45,0.11), rgba(240,155,60,0.08))",
    dominantBg: "linear-gradient(135deg, #E85030 0%, #F07835 55%, #F5A840 100%)",
    dominantShadow: "0 8px 22px rgba(210,90,40,0.22), 0 3px 8px rgba(0,0,0,0.20), inset 0 1px 3px rgba(255,255,255,0.13)",
    dominantBorder: "1px solid rgba(240,130,55,0.38)",
    border: "rgba(240, 130, 55, 0.38)",
    icon: "🔥",
  },
  air: {
    name: "Air",
