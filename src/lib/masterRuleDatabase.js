...
export const MASTER_DB_SUMMARY = {
  ...
  ingestionStatus: {
    ...
    pp_559_to_600: "COMPLETE — Aquarius all 14 entities (Deli sign + Kambriel + Athor + Polayan + Ansuel + Saspam + Abdaron + Gerodiel + Aniel + Chamiah + Rehael + Yeyazel + Hahahel + Michael)",
    pp_601_to_618: "COMPLETE — Pisces start: Dagim(57) + Amnitziel(232) + Vakabiel(69) + Ramara(441) + Nathdorinel(751 partial Venus/Mercury)",
    pp_619_to_658: "MISSING — Pisces continuation (House 12 Angel, Decanates 1–3, Quinances 1–6) + Saturn chapter opening",
