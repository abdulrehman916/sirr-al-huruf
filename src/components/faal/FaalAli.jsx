...
export default function FaalAli() {
  ...
  const currentInstructions = lang === 'ml' ? aliInstructionsML : aliInstructionsEN;
          ...
          >
            ...
            <SectionCard>
              <div className="flex items-center justify-between mb-2">
                <SectionLabel>📜 {lang === 'ml' ? 'ഫാൽ അലി എടുക്കുന്ന വിധം' : 'How to Perform Faal Ali'}</SectionLabel>
                <motion.button
