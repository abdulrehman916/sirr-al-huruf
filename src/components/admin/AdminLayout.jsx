...
import { Shield, LayoutDashboard, Users, KeyRound, Globe, MessageSquare, FileText, Settings, ChevronLeft, PanelLeftOpen, PanelLeftClose, Inbox, Tag } from "lucide-react";
...
const SIDEBAR_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/admin/pricing-dashboard", label: "Pricing & Plans", icon: Tag },
    ]
  },
  {
    label: "Support",
