    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-xl border p-4 text-center"
          ...
          <p className="font-inter text-sm" style={{ color: "rgba(255,255,255,0.30)" }}>
            Pending PDF rules
          </p>
        </div>
      ...
      <div className="mt-3 rounded-xl border p-4 text-center"
        ...
        <p className="font-inter text-xs" style={{ color: "rgba(255,255,255,0.40)" }}>
          Celestial calculations will be added from PDF manuscript sources.
        </p>
      </div>
    </motion.div>
  );
