...
export default function HadimPage() {
  ...
  const handleGenerate = () => {
    ...
    setResult({ allFields, grandTotal, sub, needed360, adjusted, final, letters, name: letters + 'ايل', breakdown: numToLettersBreakdown(final), perInput, type });
  };
            ...
            <motion.div key="hadim-results" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="space-y-3">
              ...
              <GlowCard>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-amiri text-xl text-white" dir="rtl">{result.letters}</span>
                </div>
              </GlowCard>
