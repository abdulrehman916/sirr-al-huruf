    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d1b2a] via-[#112236] to-[#0a1520] text-white font-inter">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 py-12 sm:py-16">
        ...
        >
          ...
          <h1 className="font-amiri text-5xl sm:text-6xl font-bold text-white">حاسبة العناصر</h1>
          <p className="font-inter text-sm text-white/40 mt-2 tracking-widest uppercase">Anasir Domination Calculator</p>
          <div className="mt-5 flex items-center justify-center gap-3">
            <div className="h-px w-16 bg-gradient-to-r from-transparent to-yellow-500/50" />
            <div className="w-1.5 h-1.5 rounded-full bg-yellow-500/60" />
            <div className="h-px w-16 bg-gradient-to-l from-transparent to-yellow-500/50" />
        ...
        <motion.div
          ...
          className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 shadow-xl mb-4 transition-shadow duration-300 hover:shadow-2xl hover:border-white/15"
        >
          <label className="block font-inter text-xs text-white/40 uppercase tracking-widest mb-3">Arabic Text Input</label>
          <textarea
            dir="rtl"
            value={anasirInput}
            ...
            >
              ...
              {anasirResult.dominant && (() => {
                ...
                return (
                  <motion.div
                    ...
                    style={{ background: el.bg, borderColor: el.border, boxShadow: `0 0 36px ${el.glow}` }}
                  >
                    <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.div
                  ...
                  className="col-span-2 bg-white/5 border border-white/10 rounded-2xl p-5 flex flex-col items-center gap-2 shadow-xl cursor-default hover:border-white/20 transition-colors"
                >
                ...
                {Object.entries(ELEMENTS).map(([key, el], i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="rounded-2xl p-5 flex flex-col items-center gap-2 border cursor-default transition-colors"
                      style={{
