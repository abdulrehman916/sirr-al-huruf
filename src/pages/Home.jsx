                    ...
                    {Object.entries(ELEMENTS).map(([key, el], i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="font-inter text-[10px] uppercase tracking-widest font-semibold" style={{ color: isDominant && el.arabicColor !== '#ffffff' ? '#1F2937' : '#FFFFFF' }}>{el.name}</span>
                          <span className="font-amiri text-base font-bold" style={{ color: isDominant && el.arabicColor !== '#ffffff' ? '#1F2937' : '#FFFFFF', fontWeight: 600 }}>{el.arabic}</span>
                          <span className="font-amiri text-3xl font-bold" style={{ color: isDominant && el.arabicColor !== '#ffffff' ? '#0F172A' : '#FFFFFF', fontWeight: 700 }}>{anasirResult.counts[key]}</span>
                          {isDominant && (
                            <span className="font-inter text-[9px] uppercase tracking-widest px-2 py-0.5 rounded-full border font-semibold mt-0.5"
                              style={isDominant && el.arabicColor !== '#ffffff'
